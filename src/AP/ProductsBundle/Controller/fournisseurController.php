...
use AP\ProductsBundle\Entity\fournisseur;
...
class fournisseurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fournisseurs = $em->getRepository('APProductsBundle:fournisseur')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AP\ProductsBundle\Form\fournisseurType', $fournisseur);
    ...
    {
        $deleteForm = $this->createDeleteForm($fournisseur);
        $editForm = $this->createForm('AP\ProductsBundle\Form\fournisseurType', $fournisseur);
